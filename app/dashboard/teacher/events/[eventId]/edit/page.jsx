// app/dashboard/teacher/events/[eventId]/edit/page.jsx
// Also used for /dashboard/teacher/events/create
"use client";
...
export default function EventForm({ params }) {
  ...
  const isEditMode =eventId !== 'create';
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <Alert>
          <AlertDescription>
            Please review all details carefully before {isEditMode ? 'updating' : 'creating'} the event. 
